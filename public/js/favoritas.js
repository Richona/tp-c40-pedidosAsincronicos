  ...
  fetch("http://localhost:3001/api/movies")
    ...
    .then(function (data) {
      ...
      if (JSON.parse(favoritas).length === 0) {
        document.getElementById("containerPelisFavs").innerHTML = "no hay pelis favs pa, toca la estrellita de alguna movie que te guste crack"
        document.getElementById("containerPelisFavs").style.fontSize = "40px"
      }
      data2.forEach((movie) => {
